...
public partial class TransactionList : ContentPage
{
    /*   * FLUXO DA ATUALIZAÇÃO
		 ...
		 * Subscribers -> TransactionList (Receba o transaction)
		*/
...

	{
        ...
        // Subscribers -> TransactionList (Receba o transaction)
        // Só vai rodar quando a mensagem for enviada
	...
	private void OnButtonClicked_To_TransactionAdd(object sender, EventArgs args)
	{
		...
		var transactionAdd = Handler.MauiContext.Services.GetService<TransactionAdd>(); // Com essa linha criamos sempre uma nova instância da transacao
    ...
    private void TapGestureRecognizer_Tapped_To_TransactionEdit(object sender, TappedEventArgs e)
    {
		...
		transactionEdit.SetTransactionEdit(transaction);
        Navigation.PushModalAsync(transactionEdit);
    }

    private async void TapGestureRecognizer_Tapped_ToDelete(object sender, TappedEventArgs e) // Em events handlers não aceita TASK nos métodos async
    {
